...
namespace eval ttk::theme::console {
  variable version 0.0.1
  variable dir [file dirname [info script]]
  package provide ttk::theme::console $version
  variable colors
  array set colors {
        -fg         "#ffffff"
        -disabledfg "#a9a9a9"
  ...
  ttk::style theme create console -parent clam -settings {
...
namespace eval ::tablelist:: {
  ...
  proc consoleTheme {} {
    ...
    array set colors [array get ttk::theme::console::colors]
